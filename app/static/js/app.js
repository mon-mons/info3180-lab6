  ...
  template: `
      ...
      <div class="form-inline d-flex justify-content-center">
          <div class="form-group mx-sm-3 mb-2">
              ...
              <p>You are searching for {{ searchTerm }} <button class="btn btn-primary mb-2"@click="searchNews">Search</button></p>
          </div>
      </div>
        <h2 id="nws">News</h2>
        <ul class="news__list">
            <li v-for="article in articles" class="news__item"> <h4>{{ article.title }}</h4> <br> <img :src="article.urlToImage" class="artimg"/>  <br> {{ article.description}}</li>
